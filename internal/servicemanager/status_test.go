...
func TestEquivalentListenerNormalizesLoopback(t *testing.T) {
	for _, tc := range []struct {
		wh, wp, ah, ap string
		want           bool
	}{{"127.0.0.1", "8051", "127.0.0.1", "8051", true}, {"localhost", "8051", "127.0.0.1", "8051", true}, {"0.0.0.0", "8051", "127.0.0.1", "8051", true}, {"::", "8051", "127.0.0.1", "8051", true}, {"127.0.0.1", "8051", "127.0.0.2", "8051", false}, {"127.0.0.1", "8051", "::1", "8051", false}, {"::1", "8051", "::1", "8051", true}, {"192.0.2.1", "8051", "192.0.2.1", "8051", true}, {"127.0.0.1", "9051", "127.0.0.1", "8051", false}} {
