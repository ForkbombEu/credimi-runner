...
require (
	github.com/forkbombeu/credimi v1.269.2-0.20260818105259-db210d4c2732
...
require (
	...
	github.com/forkbombeu/credimi-extra v1.14.4-0.20260818105125-1e655f704460 // indirect
