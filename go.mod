...
require (
	github.com/forkbombeu/credimi v1.269.2-0.20260827075051-9a0d9ddb47db
...
require (
	...
	github.com/forkbombeu/credimi-extra v1.14.4-0.20260827074854-2b63092bd33c // indirect
