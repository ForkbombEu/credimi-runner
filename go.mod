...
require (
	github.com/forkbombeu/credimi v1.269.2-0.20260818150336-c64cf11fb568
...
require (
	...
	github.com/forkbombeu/credimi-extra v1.14.4-0.20260818150047-26030ef4bef0 // indirect
