...
require (
	github.com/forkbombeu/credimi v1.195.0
...
require (
	...
	github.com/forkbombeu/avdctl v0.9.0 // indirect
	github.com/forkbombeu/credimi-extra v1.10.0 // indirect
...
replace github.com/forkbombeu/credimi => ../credimi-2
