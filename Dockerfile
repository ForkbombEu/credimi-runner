...
ENV DEBIAN_FRONTEND=noninteractive \
    ...
    PATH=/opt/android-sdk/cmdline-tools/latest/bin:/opt/android-sdk/platform-tools:/opt/android-sdk/emulator:/opt/android-sdk-bootstrap/cmdline-tools/latest/bin:/root/.maestro/bin:$PATH
RUN apt-get update && apt-get install -y --no-install-recommends \
    ...
    sdkmanager --sdk_root="$ANDROID_SDK_BOOTSTRAP" "build-tools;35.0.0" && \
