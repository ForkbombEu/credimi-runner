...
func TestValidateActionIdentifier(t *testing.T) {
	t.Run("client call fails", func(t *testing.T) {
		...
		_, err := validateActionIdentifier("http://example.local/validate", "wallet/action", "api-key", client)
	...
	t.Run("success", func(t *testing.T) {
		...
		code, err := validateActionIdentifier("http://example.local/validate", "wallet/action", "api-key", client)
...
func TestDownloadFileIfMissing_ErrorPaths(t *testing.T) {
	t.Run("mkdir fails", func(t *testing.T) {
		_, err := downloadFileIfMissing("http://example.local/file.apk", "api-key", "apk", "file.apk", &fakeHTTPClient{}, &failingFileStore{
	...
	t.Run("invalid request URL", func(t *testing.T) {
		_, err := downloadFileIfMissing(":", "api-key", "apk", "file.apk", &fakeHTTPClient{}, &failingFileStore{
	...
	t.Run("download request fails", func(t *testing.T) {
		...
		_, err := downloadFileIfMissing("http://example.local/file.apk", "api-key", "apk", "file.apk", client, &failingFileStore{
			statErr: os.ErrNotExist,
		})
...
func TestDownloadInstallerIfMissing_ErrorPropagation(t *testing.T) {
	_, err := downloadInstallerIfMissing(":", "api-key", "ios", "app.zip", "ios", &fakeHTTPClient{}, &failingFileStore{
		statErr: os.ErrNotExist,
	})
	require.ErrorContains(t, err, "failed to create request")
}
